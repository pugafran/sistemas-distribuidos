...
int main(int argc, char *argv[])
{
  ...
  while (1) {
    ...
    // &tid: puntero al hilo pthread_t
    // NULL: No le pasamos un puntero a atributos de hilo
    // servicioEcho: puntero a la función que ejecutan los hilos
    // con: puntero a la estructura de conexión que utiliza la función
